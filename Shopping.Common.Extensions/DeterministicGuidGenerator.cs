...
namespace Shopping.Common.Extensions
{
    public static class DeterministicGuidGenerator
    {
        ...
        public static readonly Guid AggregateNamespace = new Guid("ef72780a-bb31-43fd-b497-7b4eb75d317d");
